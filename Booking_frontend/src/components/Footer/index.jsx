          ...
          <Col xs={3} md={3} lg={2}>
            <div>
              <ul>
                ...
                <li>Reviews</li>
                <li>unpacked:Travels articles</li>
      ...
      <Container className="text-center mb-4">
        <span className="follow" onClick={() => setShowIcons(!showIcons)}>
          ...
          <div className="icons">
            ...
            <a href="https://twitter.com/" target="_blank" className="ms-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <a href="https://facebook.com/" target="_blank" className="ms-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <a href="https://youtube.com/" target="_blank" className="ms-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
